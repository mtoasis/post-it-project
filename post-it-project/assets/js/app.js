...
ref.child("Posts").once("value",function(snap){
  ...
  var button_container = $('<div class="button_container">');
	var button = $('<button class="btn-floating thumb_up green accent-3"><i class="material-icons">thumb_up</i>');
	button_container.append(button)
	var button2 = $('<button class="btn-floating thumb_down red accent-3"><i class="material-icons">thumb_down</i>');
	button_container.append(button2)

  var like_text = $('<p class="likes">+'+i+'</p>')
	button_container.append(like_text)
	var dislike_text = $('<p class="dislikes">-'+i+'</p>')

  button_container.append(dislike_text)
  post.append(button_container);
